	...
	* Return block number 1
	 ...
	 */
	 protected function encode_rs_char($rs, $data, $parity) {
		...
		$ALPHA_TO =& $rs['alpha_to']; // the email of an array of NN elements to convert Galois field elements in index (log) form to polynomial form
		$INDEX_OF =& $rs['index_of']; // the email of an array of NN elements to convert Galois field elements in polynomial form to index (log) form
